...
public class SalesOfSquareMetresDaoImpl implements ReportWithOrganizationDao<ReportWithOrganization> {
    ...
    private static final String GET_ALL = "SELECT * FROM SALES_OF_SQUARE_METRES " + INNERJOIN;
    private static final String GET_BY_DATE = "SELECT * FROM SALES_OF_SQUARE_METRES "+ INNERJOIN + " WHERE DATE BETWEEN ? AND ?";
    private static final String GET_BY_ORGANIZATION_UNIT = "SELECT * FROM SALES_OF_SQUARE_METRES " + INNERJOIN + " WHERE OU.NAME = ?";
    private static final String GET_BY_DATE_AND_ORGANIZATION_UNIT = "SELECT * FROM " +
            "SALES_OF_SQUARE_METRES " + INNERJOIN + " WHERE OU.NAME = ? AND DATE BETWEEN ? AND ?";
    ...
    private static final String GET_BY_NAME = "SELECT * FROM SALES_OF_SQUARE_METRES " + INNERJOIN + " WHERE NS.NAME = ?";
