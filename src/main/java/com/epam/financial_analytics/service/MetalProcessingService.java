...
public class MetalProcessingService implements Service {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        OrganizationUnit organizationUnitKaraganda = organizationUnitDao.getByName(req.getParameter(KARAGANDA));
        OrganizationUnit organizationUnitAlmaty = organizationUnitDao.getByName(req.getParameter(ALMATY));
