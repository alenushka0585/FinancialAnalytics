...
public class PercentExpenseToRevenueIndicator extends Indicator implements Fillable {
    ...
    public void fillIndicator() {
        setPresentPeriodIndicator(IndicatorUtil.countPercentOneToAnother(totalExpenseIndicator.getPresentPeriodIndicator(),
                revenueIndicator.getPresentPeriodIndicator()));
        setPastPeriodIndicator(IndicatorUtil.countPercentOneToAnother(totalExpenseIndicator.getPastPeriodIndicator(),
                revenueIndicator.getPastPeriodIndicator()));
