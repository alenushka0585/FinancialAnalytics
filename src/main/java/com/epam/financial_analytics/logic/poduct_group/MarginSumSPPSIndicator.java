...
public class MarginSumSPPSIndicator extends MarginSumProductGroupIndicator implements Fillable {
    public MarginSumSPPSIndicator(Date presentPeriodStartDate, Date presentPeriodFinishDate, Date pastPeriodStartDate, Date pastPeriodFinishDate, String currencyName) {
