...
public class SalesSumSEOIndicator extends SalesSumProductGroupIndicator implements Fillable {
    public SalesSumSEOIndicator(Date presentPeriodStartDate, Date presentPeriodFinishDate, Date pastPeriodStartDate, Date pastPeriodFinishDate, String currencyName) {
