...
public class MarginSumTSPIndicator extends MarginSumProductGroupIndicator implements Fillable {

    public MarginSumTSPIndicator(Date presentPeriodStartDate, Date presentPeriodFinishDate, Date pastPeriodStartDate, Date pastPeriodFinishDate, String currencyName) {
