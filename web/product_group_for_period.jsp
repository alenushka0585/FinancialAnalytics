                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="${pageContext.request.contextPath}/product_group_for_period.jsp?language=ru">RU</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="${pageContext.request.contextPath}/product_group_for_period.jsp?language=en">EN</a>
                        </li>
                    </ul>
...
<main class="main">
    ...
    <br>
    <div class="container">
        <form name="result" action="${pageContext.request.contextPath}/controller/product_group_for_period" method="post">
