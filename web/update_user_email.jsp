                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="${pageContext.request.contextPath}/update_user_email.jsp?language=ru">RU</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link" href="${pageContext.request.contextPath}/update_user_email.jsp?language=en">EN</a>
                        </li>
                    </ul>
...
<main class="main">
    ...
    <div class="container">
        <form name="updateUser" action="${pageContext.request.contextPath}/controller/update_user_email" method="post">
            <div class="form-row justify-content-center">
                ...
                <div class="col-sm-2.5">
                    <select id="kindOfReport" class="form-control" name="kindOfReport" size="1">
                        <option value="<fmt:message key="updating.email"/>"><fmt:message key="updating.email"/></option>
                    </select>
                </div>
            </div>
            <br>
            ...
            <div class="form-row justify-content-center">
                <h6 class="col-sm-2 col-form-label" ><fmt:message key="new.email"/>:</h6>
